        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div>
                    ...
                    onclick="RequestRevise('<?php echo md5($doc_id)?>','<?php echo $approval_mail?>','<?php echo $approval_name?>','<?php echo $method_statement?>','<?php echo $doc_no?>','<?php echo $preparedby?>','<?php echo $date?>','Revise')" title="Send Request">
