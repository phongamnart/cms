...
<head>
    ...
    while ($objResult = mysqli_fetch_assoc($objQuery)) {
        ...
        $request = $objResult['req_revise'];
        $status_req = $objResult['status_rev'];
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <form action="services/add_request.php" method="post">
                    <div>
                        <!-- menu header -->
                        <button type="button" class="btn btn-app flat" onClick="window.location.href='approval_revise.php'" title="<?php echo BTN_DISCARD; ?>">
                        ...
                        onclick="revApproved('<?php echo md5($id); ?>','<?php echo md5($doc_id); ?>','<?php echo $createReq; ?>','<?php echo $to_name; ?>','<?php echo $method_statement; ?>','<?php echo $doc_no; ?>','<?php echo $preparedby; ?>','<?php echo $currentTime; ?>','Revise')" 
                        title="Approve<?php echo $id?>">
                            <img src="dist/img/icon/approved.svg" width="24"><br>
                            Approve
                        </button>
                        <button type="button" class="btn btn-app flat" 
                        onclick="revReject('<?php echo md5($id); ?>','<?php echo $createReq; ?>','<?php echo $to_name; ?>','<?php echo $method_statement; ?>','<?php echo $doc_no; ?>','<?php echo $preparedby; ?>','<?php echo $currentTime; ?>','Revise')" 
                        title="Reject">
