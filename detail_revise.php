            ...
            <section class="content">
                ...
                <form action="services/add_request.php" method="post">
                    <div>
                        ...
                        <button type="button" class="btn btn-app flat" onclick="revApproved('<?php echo md5($id); ?>','<?php echo $doc_no; ?>','<?php echo md5($doc_id); ?>')" title="Approve<?php echo $id?>">
                            <img src="dist/img/icon/approved.svg" width="24"><br>
                            Approve
                        </button>
                        <button type="button" class="btn btn-app flat" onclick="revReject('<?php echo md5($id); ?>','<?php echo $doc_no; ?>')" title="Reject">
