                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select"
                                                    ...
                                                    onChange="setFilter('documents_list_discipline',this.value)">
                                                    <option value="">All</option>
                                                    <?php
												$objQueryDisc = $conDB->sqlQuery($strSQLDisc);
												while($objResultDisc = mysqli_fetch_assoc($objQueryDisc)) { 
													if($objResultDisc['discipline'] == $documents_list_discipline){$selected = "selected";}else{$selected ="";}
                                    ...
                                    <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select"
                                                    style="width: 100%;" <?php echo $mode_select; ?>
                                                    onChange="setFilter('documents_list_work',this.value)">
                                                    <option value="">All</option>
                                                    <?php
												$objQueryWork = $conDB->sqlQuery($strSQLWork);
												while($objResultWork = mysqli_fetch_assoc($objQueryWork)) { 
													if($objResultWork['work'] == $documents_list_work){$selected = "selected";}else{$selected ="";}
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select"
                                                    style="width: 100%;" <?php echo $mode_select; ?>
                                                    onChange="setFilter('documents_list_type',this.value)">
                                                    <option value="">All</option>
                                                    <?php
												$objQueryType = $conDB->sqlQuery($strSQLType);
												while($objResultType = mysqli_fetch_assoc($objQueryType)) { 
													if($objResultType['type'] == $documents_list_type){$selected = "selected";}else{$selected ="";}
                                    ...
                                    <table id="datatable" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr
                                                onDblClick="window.location.href='documents_list_edit.php?no=<?php echo md5($objResult['id']); ?>'">
                                                <td><?php echo $index++; ?></td>
                                                <td align="center">
                                                    <img src="dist/img/icon/doc.png" onclick="window.location.href='documents_edit.php?no=<?php echo md5($objResult['id']); ?>'"
                                                    title="Download Word" width="30" style="padding: 2px;cursor: pointer;"/>
                                                    <img src="dist/img/icon/pdf.png" onclick="window.location.href='documents_edit.php?no=<?php echo md5($objResult['id']); ?>'"
                                                    title="Download Pdf" width="30" style="padding: 2px;cursor: pointer;"/>
                                                </td>
