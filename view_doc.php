    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div>
                    <!-- menu header -->
                    <button type="button" class="btn btn-app flat" onclick="window.location.href='documents_edit.php?no=<?php echo md5($doc_id) . '&l=' . $type_doc .'&m=' . md5($doc_no . '1'); ?>'" title="<?php echo BTN_DISCARD; ?>">
